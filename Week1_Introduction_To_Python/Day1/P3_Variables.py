...
print("Integer addition with var num:", num + num)
print("Float addition with var numFloat:", numFloat + numFloat)
print("String addition with var numWord:", numWord + numWord)

# Know the type of vairable using type() function
# Simple example:
